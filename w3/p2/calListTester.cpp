...
// Revision History
// -----------------------------------------------------------
// Name  Siripa Purinruk     Date  02/May/2023          Reason
//
/////////////////////////////////////////////////////////////////
***********************************************************************/
...
int main() {
    CalorieList CL;
    CL.init(5);
    CL.add("Cheerios Cereal with 2% milk", 170, c_breakfast);//valid
    CL.display();
    CL.add(nullptr, 100, c_breakfast);//invalid
    CL.add("Cheeseburger", 303, c_lunch);//valid
    CL.add("Pepsi", 150, 0);//invalid
    CL.add("Apple", 52, c_snack);//valid
    CL.display();
    CL.deallocate();
    CL.init(9);
    ...
    CL.display();
    CL.deallocate();
    testDMA(CL); // uncomment to test DMA
    return 0;
}
