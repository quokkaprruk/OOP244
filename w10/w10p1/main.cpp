...
// Revision History
// -----------------------------------------------------------
// Name  Siripa Purinruk          Date  2/8/2023          Reason
//
/////////////////////////////////////////////////////////////////
***********************************************************************/
...
int main() {
   ...
   listArrayElements("All the cars:", C, sizeof(C) / sizeof(C[0]));
   ...
   listArrayElements("All students:", S, sizeof(S) / sizeof(S[0]));
   ...
   listArrayElements("All employees:", E, sizeof(E) / sizeof(E[0]));
